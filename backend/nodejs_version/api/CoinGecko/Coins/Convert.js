...
exports.getAllFromRangeJSON = void 0;
// Global constants:
/**
 ...
 */
const filterDublicateDates = (arr) => {
 ...
 */
const getMarketRows = (prices, bear) => {
    ...
    const compare = (current, last) => (bear) ? (current > last) : (current < last);
...
function getA(data) {
    ...
    const max = (_a = last === null || last === void 0 ? void 0 : last.days) !== null && _a !== void 0 ? _a : -1;
...
function getB(data) {
    ...
    const maxVal = (_a = total_volumes.pop()) !== null && _a !== void 0 ? _a : [-1, -1];
 ...
 */
function getAllFromRangeJSON(data) {
...
exports.getAllFromRangeJSON = getAllFromRangeJSON;
